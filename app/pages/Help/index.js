...
const Help = () => {
    return <div>
    <div class={`alert shadow-lg ${classes.notification}`}>
  <div>
    ...
    <p>3. If your account doesn't connect automatically just click the 'Connect MetaMask' button to connect MetaMask.</p>
